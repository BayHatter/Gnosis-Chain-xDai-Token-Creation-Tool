# Gnosis Token Creation Tool

A simple frontend tool to create tokens on the Gnosis (xDai) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Gnosis-Chain-xDai-Token-Creation-Tool.git
- And press deploy
- Congrats your Gnosis Chain xDai Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Gnosis-Chain-xDai-Token-Creation-Tool
- Upload into your Github repo.
- Edit the file public/config.json and insert your Gnosis wallet address for receiving fees. Also set fee in xDAI that you want to charge
